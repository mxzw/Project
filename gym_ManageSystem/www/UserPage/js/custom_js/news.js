...
$(document).ready(function () {
    ...
    function editRow(fTable, frow) {
        ...
        ftable[3].innerHTML = '<a class="edit btn btn-success btn-xs" href="">Save</a>';
        ftable[4].innerHTML = '<a class="cancel btn btn-danger btn-xs" href="">Cancel</a>';
    }
    ...
    function saveRow(fTable, frow) {
        ...
        fTable.fnUpdate('<a class="edit btn btn-primary btn-xs" href=""><i class="fa fa-fw fa-edit"></i> Edit</a>', frow, 3, false);
        fTable.fnUpdate('<a class="delete btn btn-danger btn-xs" href=""><i class="fa fa-trash-o"></i> Delete</a>', frow, 4, false);
        fTable.fnDraw();
    }
